...
export const Footer = () => {
  ...
  return (
    <div className="w-full select-none bg-[#ecf0f3] text-[#1f2937] dark:bg-gray-800">
      {/* md:py-20 */}
      <div className="max-w-[1240px] mx-auto px-4 py-10">
        {/* For Spotify */}
        <div className="flex sm:flex-row mb-6 space-x-0 sm:space-x-2 w-full">
          <svg className="h-5 w-5 mr-2 ml-auto mt-1" viewBox="0 0 168 168">
            <path
              fill="#1ED760"
          ...
          <div className="inline-flex flex-row sm:flex-row w-full max-w-full truncate">
            ...
            <span className="mx-2 text-gray-500 dark:text-gray-300 sm:block">
              {" – "}
            </span>
